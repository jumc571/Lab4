...
app.post('/home/pick_color', function(req, res) {
	...
	var color_select = 'SELECT name FROM favorite_colors;';
...
app.get('/team_stats', function(req, res){
	var season_list = "SELECT * FROM football_games WHERE game_date > '2020-09-04' AND game_date < '2020-11-29';";
	var season_wins = "SELECT COUNT(*) FROM football_games WHERE home_score > visitor_score;";
	var season_losses = "SELECT COUNT(*) FROM football_games WHERE home_score < visitor_score;";
	db.task('get-everything', task => {
	return task.batch([
		task.any(season_list),
		task.any(season_wins),
		task.any(season_losses)
	]);
})
.then(data => {
